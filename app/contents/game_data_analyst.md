---json
{
  ...
  "title": "【ゲームデータアナリスト】年収・将来性は？未経験から目指す完全ロードマップ"
}
---
...
| 経験年数 | 年収範囲 (万円) | 特徴 |
| :--- | :--- | :--- |
| ジュニア (0-3年) | 350〜550 | SQLの基本操作やダッシュボード作成、定型レポートの抽出が中心。未経験からのポテンシャル採用も含む。 |
| ミドル (3-7年) | 550〜850 | KPI設計、A/Bテストの実施、Python/Rを用いた高度な分析。施策立案による売上貢献が評価される。 |
| シニア (7年以上/リード) | 850〜1,200+ | 意思決定に直結する戦略提言、機械学習モデルの実装、チームマネジメント。大手や外資系では1,500万超も。 |
