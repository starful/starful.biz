---json
{
  ...
  "title": "【リサーチサイエンティスト】年収・将来性は？未経験から目指す完全ロードマップ"
}
---
...
| 経験年数 | 年収範囲 (万円) | 特徴 |
| :--- | :--- | :--- |
| ジュニア (0-3年) | 500〜800 | 修士・博士号保持者が中心。基礎研究の補助や特定技術の実装からスタート。 |
| ミドル (3-7年) | 800〜1,300 | 専門分野を確立し、プロジェクトを主導。国内外の学会発表や特許出願を行う。 |
| シニア (7年以上/リード) | 1,300〜2,500以上 | 技術戦略の策定やチーム統括を担当。GAFA等の外資系やAIベンチャーでは2,000万超も。 |

### キャリアコンサルタントの補足
リサーチサイエンティスト（特にAI・データサイエンス領域）は、日本国内でも非常に希少価値が高く、将来性は極めて明るい職種です。未経験から目指す場合は、まずデータサイエンティストやエンジニアとして実務経験を積みながら、特定のドメイン（深層学習、自然言語処理など）の専門性を深めるロードマップが一般的です。
