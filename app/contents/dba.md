---json
{
  ...
  "title": "DBAの年収・将来性は？未経験から専門職を目指す完全ロードマップ"
}
---
...
| 経験年数 | 年収範囲 (万円) | 特徴 |
| :--- | :--- | :--- |
| ジュニア (0-3年) | 350〜500 | 運用保守、SQLの基礎習得、バックアップ確認などの定型業務が中心。 |
| ミドル (3-7年) | 500〜850 | パフォーマンスチューニング、クラウド移行（AWS/Azure等）、DB設計の実施。 |
| シニア (7年以上/リード) | 850〜1,200+ | 大規模・高可用性アーキテクチャ設計、セキュリティ戦略、チームマネジメント。 |
