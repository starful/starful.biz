---
category: design
keywords: UX/UIデザイナー, Figma, ユーザーリサーチ, デザインシステム, プロダクトデザイン
meta_description: UX/UIデザイナーの役割、具体的な業務内容、Figmaなどの必要なスキル、キャリアパス、そして面接想定質問を解説。
related_jobs:
- product_manager
- frontend_engineer
slug: uxui_designer
...
- プロトタイピング
- Atomic Design
thumbnail: /static/img/uxui_designer.png
title: UX/UIデザイナーのプロジェクトポジション
---
